...
Proof.
  unfold det_nfa'_with_accept_states; intro H.
...
Proof.
  ...
  generalize dependent (filter (fun Q => if has_accept_state_dec State_eq_dec g Q then true else false) (states (det_nfa'_normalized g)));
  intro s.
...
Proof.
  ...
  - clear H.
    ...
    + apply normalize_accept_states in H.
      ...
      contradiction.
    + generalize dependent (states (det_nfa'_normalized g));
      intros s H.
